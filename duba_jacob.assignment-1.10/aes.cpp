...
/**
 * Populates keys.
 * keys[0] is the cypher key and key[1-10] are the round keys
 */
void expand_keys(uint8_t keys[ROUNDS + 1][4][4], uint8_t key[4][4]) {
...
void mix_columns(uint8_t state[4][4]) {
    ...
    // (https://wikimedia.org/api/rest_v1/media/math/render/svg/96d33a166dc721d812d9a559c0d12bcbeaf03d5f)
    for (int j = 0; j < 4; j++) {
        b0 = state[0][j];
        b1 = state[1][j];
        b2 = state[2][j];
        ...
        d0 = mult_2[b0] ^ mult_3[b1] ^ b2 ^ b3;
        d1 = b0 ^ mult_2[b1] ^ mult_3[b2] ^ b3;
        d2 = b0 ^ b1 ^ mult_2[b2] ^ mult_3[b3];
        d3 = mult_3[b0] ^ b1 ^ b2 ^ mult_2[b3];
